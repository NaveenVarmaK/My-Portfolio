    ...
    >
      ...
      <Typography
        ...
        sx={{
          ...
          fontSize: { xs: '60rem', md: '30rem' }, // Responsive font size
          fontWeight: 900,
      ...
      >
        {/* First Card */}
        <Card sx={{ minWidth: 600, maxWidth: 500 , mt: 5}}>
          ...
          <CardContent>
            ...
            <Typography variant="body2">
              I pursued a Master's degree in Computer Science with a focus on software development, data analysis, and machine learning. The program provided a strong foundation in algorithms, data structures, and modern software engineering practices.
            </Typography>
          </CardContent>
